        ...
        <div className="container">
            ...
            <div className="relative">
                ...
                <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto">
                    ...
                    width={800} height={730} alt='Smartest AI' src={service1}/>
                </div>
                <div className="realative z-1 max-w-[17rem] ml-auto">
                    <h4 className="h4 mb-4">Smartest AI</h4>
                    <p className="body-2 mb-[3rem] text-n-3">Brainwave unlocks the potential of AI-powered applications</p>
                    <ul className="body-2">
                         {brainwaveServices.map((item, index)=>(
                            <li className="flex items-start py-4 boder-t border-n-6" key={index}>
        ...
        <div className='relative z-1 grid gap-5 lg:grid-cols-2'>
                    ...
                    <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
                        ...
                        <div className="relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem]">
                            <img src={service3} className="w-full h-full object-cover" width={520} height={400} alt='SScary robot'/>
